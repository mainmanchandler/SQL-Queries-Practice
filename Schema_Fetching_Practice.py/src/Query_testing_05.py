...
from Schema_Fetching_Methods import get_key_info
SEP = "-"*100

try:    
        print('Testing get_key_info:\n')
        ...
        all_rows = get_key_info(cursor, "dcris", "pub", "pub_type")   
        for i in all_rows:
            print(i)
        ...
        all_rows = get_key_info(cursor, "dcris", "pub")   
        for i in all_rows:
            print(i)
        ...
        all_rows = get_key_info(cursor, "dcris", None, "pub_type")   
        for i in all_rows:
            print(i)
        ...
        all_rows = get_key_info(cursor, "dcris")
        for i in all_rows:
            print(i)
